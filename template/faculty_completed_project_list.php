   ...
   ?>
        ...
        <div class="h-full mx-auto w-4/5 px-4 lg:px-12 ">
            ...
            <div class="bg-white :bg-gray-800 relative shadow-md sm:rounded-lg ">
                ...
                <div
                    ...
                    <h1 class="title-box ">List of Completed Projects</h1>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 :text-gray-400">
                        ...
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 :bg-gray-700 :text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Requirment Document</th>
                                <th scope="col" class="px-4 py-3">POC</th>
                                <th scope="col" class="px-4 py-3">Project Allocation</th>
    ...
    <script>
        ...
        function showdata() {
            ...
            $.ajax({
                url: "../utils/show_completed_data.php",
            }).done(function (data) {
                $('#result').html(data);
                //data == response
            });
