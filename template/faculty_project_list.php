   ...
   ?>
    ...
    <script>
        ...
        function submitForm(post_id) {
            ...
            // Append the post_id and file to the FormData object
            formData.append('post_id', post_id);
            formData.append('file', fileInput.files[0]); // Assuming the file input is for the file you want to upload

            // Send the data to the backend using fetch
            fetch("../forms/upload.php", {
                method: "POST",
                ...
                .then(data => {
                    ...
                    toggleModal();
                    location.reload(); // Hide modal after submission (if needed)
                })
                .catch(error => {
