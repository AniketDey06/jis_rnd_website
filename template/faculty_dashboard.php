...
<body class="text-gray-800 font-inter">
  ...
  <!--sidenav -->
  <div class="fixed left-0 top-0 w-64 h-full flex flex-col items-center bg-[#ffffff] p-4 z-50 sidebar-menu transition-transform">
    ...
    <ul class="mt-4">
      <span class="text-gray-400 font-bold">FACULTY</span>
      <li class="mb-1 group">
        <a href=""
        ...
        <li class="dropdown ml-3">
          <button type="button" class="dropdown-toggle flex items-center">
            ...
            <div class="p-2 md:block text-left">
              <h2 class="text-sm font-semibold text-gray-800"><?= htmlspecialchars($user['name'], ENT_QUOTES, 'UTF-8') ?></h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
          <div class="flex justify-between mb-6">
            <div>
              <div class="text-2xl font-semibold">New Projects</div>
          ...
          <a href="faculty_project_list.php" class="text-[#f84525] font-medium text-sm hover:text-red-800">View</a>
        </div>
        ...
        <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
          ...
          <a href="faculty_ongoing_project.php" class="text-[#f84525] font-medium text-sm hover:text-red-800">View</a>
        </div>
        ...
        <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
          ...
          <a href="faculty_completed_project_list.php" class="text-[#f84525] font-medium text-sm hover:text-red-800">View</a>
        </div>
  ...
  <script>
    ...
    function loadProjects() {
      $.ajax({
        type: "GET",
        url: "../utils/fetch_projects.php", // Backend script that fetches projects
