...
<body class="text-gray-800 font-inter">
  ...
  <!--sidenav -->
  <div
    class="fixed left-0 top-0 w-64 h-full flex flex-col items-center bg-[#ffffff] p-4 z-50 sidebar-menu transition-transform">
    <a href="#" class="flex items-center ">

      <h2 class="font-bold text-2xl">
        <img src="../assets/images/JIS_Logo.png" class="logo" alt="">
        <!-- LOREM 
    ...
    <ul class="mt-4">
      ...
      <li class="mb-1 group">
        ...
        <ul class="pl-7 mt-2 hidden group-[.selected]:block">
          ...
          <li class="mb-4">
            <a href=""
              class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Admin</a>
          </li>
          <li class="mb-4">
            <a href=""
              class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Principle</a>
          </li>
          <li class="mb-4">
            <a href=""
              class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Faculty</a>
          </li>
        </ul>
      </li>
  ...
  <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-200 min-h-screen transition-all main">
    <!-- navbar -->
    <div class="py-2 px-6 bg-[#ffffff] flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-30">
          ...
          <ul
            ...
            <li>
              <form method="POST" action="">
                <a role="menuitem" tabindex="-1" href="../utils/logout.php"
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
          <div class="flex justify-between mb-6">
            <div>
              <div class="text-2xl font-semibold">Manage Project</div>
              <div class="flex items-center mb-1">
                <div id="projectCount" class="text-2xl font-semibold">0</div>
              </div>
            </div>

          </div>

          <a href="project_list.php" class="text-[#f84525] font-medium text-sm hover:text-red-800">View</a>
        </div>

        <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
          <div class="flex justify-between mb-6">
            <div>
              <div class="text-2xl font-semibold">Ongoing Projects</div>
              <div class="flex items-center mb-1">
                <div id="ongoingProjectCount" class="text-2xl font-semibold">0</div>
              </div>
            </div>
          </div>

          <a href="ongoing_project.php" class="text-[#f84525] font-medium text-sm hover:text-red-800">View</a>
        </div>

        <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
          <div class="flex justify-between mb-6">
            <div>
              <div class="text-2xl font-semibold">Completed Projects</div>
              <div class="flex items-center mb-1">
                <div id="completedProjectCount" class="text-2xl font-semibold">0</div>
              </div>
            </div>
          </div>

          <a href="completed_project.php" class="text-[#f84525] font-medium text-sm hover:text-red-800">View</a>
        </div>
              ...
              <table class="items-center w-full bg-transparent border-collapse">
                ...
                <tbody>
                  <tr class="text-gray-700 dark:text-gray-100">
                    ...
                    <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                      <div class="flex items-center">
                        <span id="adminPercentage" class="mr-2">0%</span>
                        <div class="relative w-full">
                          <div class="overflow-hidden h-2 text-xs flex rounded bg-blue-200">
                            <div id="adminProgressBar" style="width: 0%"
                  ...
                  <tr class="text-gray-700 dark:text-gray-100">
                    ...
                    <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                      <div class="flex items-center">
                        <span id="facultyPercentage" class="mr-2">0%</span>
                        <div class="relative w-full">
                          <div class="overflow-hidden h-2 text-xs flex rounded bg-green-200">
                            <div id="facultyProgressBar" style="width: 0%"
  ...
  <script>
    ...
    function fetchProjectCount() {
      $.ajax({
        type: "GET",
        url: "get_project_count.php", // Backend script to get project count
        success: function (response) {
          var res = JSON.parse(response);
          if (res.success) {
            document.getElementById("projectCount").textContent = res.count;
          } else {
            console.error("Error: " + res.message);
          }
        },
        error: function () {
          console.error("An error occurred while fetching project count.");
        }
      });
    }
    ...
    function fetchOngoingProjectCount() {
      $.ajax({
        type: "GET",
        url: "get_ongoing_project_count.php", // Backend script to get ongoing project count
        success: function (response) {
          var res = JSON.parse(response);
          if (res.success) {
            document.getElementById("ongoingProjectCount").textContent = res.count;
          } else {
            console.error("Error: " + res.message);
          }
        },
        error: function () {
          console.error("An error occurred while fetching ongoing project count.");
        }
      });
    }
    ...
    function loadProjects() {
      $.ajax({
        type: "GET",
        url: "fetch_projects.php", // Backend script that fetches projects
        success: function (response) {
          document.getElementById("projectsTableBody").innerHTML = response;
        },
        error: function () {
          console.error("An error occurred while loading the projects.");
        }
      });
    }
    ...
    function fetchCompletedProjects() {
      $.ajax({
        type: "GET",
        url: "get_completed_projects.php", // PHP script to fetch completed projects count
        success: function (response) {
          var res = JSON.parse(response);
          if (res.success) {
            document.getElementById("completedProjectCount").textContent = res.count;
          } else {
            console.error(res.message);
          }
        },
        error: function () {
          console.error("An error occurred while fetching completed projects count.");
        }
      });
    }
    ...
    function fetchAdminStats() {
      $.ajax({
        type: "GET",
        url: "get_admin_stats.php", // Backend script to fetch admin count & percentage
        success: function (response) {
          var res = JSON.parse(response);
          if (res.success) {
            document.getElementById("adminCount").textContent = res.admin_count;
            document.getElementById("adminPercentage").textContent = res.admin_percentage + "%";
            document.getElementById("adminProgressBar").style.width = res.admin_percentage + "%";
          } else {
            console.error(res.message);
          }
        },
        error: function () {
          console.error("An error occurred while fetching admin stats.");
        }
      });
    }
    ...
    function fetchAdminFacultyStats() {
        $.ajax({
            type: "GET",
            url: "get_admin_faculty_stats.php", // The updated PHP file
            success: function(response) {
                var res = JSON.parse(response);
                if (res.success) {
                    
                    // Update Faculty Data
                    document.getElementById("facultyCount").textContent = res.faculty_count;
                    document.getElementById("facultyPercentage").textContent = res.faculty_percentage + "%";
                    document.getElementById("facultyProgressBar").style.width = res.faculty_percentage + "%";
                } else {
                    console.error(res.message);
                }
            },
            error: function() {
                console.error("An error occurred while fetching admin & faculty stats.");
            }
        });
    }
